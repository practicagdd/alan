...
SUM(CASE WHEN ((P.PART_VISITANTE = DP.DEPA_EQUIPO AND DP.DEPA_ACCION = 1) OR (P.PART_LOCAL = DP.DEPA_EQUIPO AND DP.DEPA_ACCION = 1)) THEN 1 ELSE 0 END) 'GOLES VISITANTE',
